<script lang="ts">
  ...
  // Clear error handlers for other fields
      ...
      <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-6">
        ...
        <form
          ...
          use:enhance={() => {
            ...
            const validation = schemas.signUpSchema.safeParse({
              name,
        ...
        >
          {#if form?.errors || form?.errorMessage}
            <div class="rounded-2xl bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/50 p-4">
              <div class="flex">
                ...
                <div class="ml-3">
                  <p class="text-sm text-red-800 dark:text-red-200 font-medium">
                    {getErrorMessages(form, t, t.error.registrationFailed)}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <input
              ...
              type="text"
              autocomplete="name"
              data-error={fieldErrors.name?.length ? "true" : "false"}
          ...
          <div>
            ...
            <div class="relative">
              <input
                ...
                data-error={fieldErrors.username?.length ? "true" : "false"}
                class="block w-full px-4 py-4 border-0 rounded-2xl text-gray-900 dark:text-white bg-gray-50 dark:bg-slate-800 placeholder-gray-400 dark:placeholder-gray-500 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#5776F3] transition-all text-base pr-12 {fieldErrors
                  .username?.length
                  ? 'ring-2 ring-red-500 dark:ring-red-500'
                  : ''}"
            ...
            {:else if usernameMessage}
              <p
                class="mt-2 text-sm {usernameStatus === 'available'
          ...
          <div>
            <label for="email" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
              {t.common.email}
              <span class="text-gray-400 dark:text-gray-500 text-xs font-normal">({t.common.optional})</span>
            </label>
            <input
              id="email"
              name="email"
