import {
  PUBLIC_BASE_URL_LOCAL_HEALTH,
  PUBLIC_BASE_URL_LOCAL_LAB,
  PUBLIC_BASE_URL_LOCAL_PLACE,
} from "$env/static/public";

export const VALID_ORIGINS = ["localhealth", "localplace", "locallab"] as const;
...
export function getOriginBaseURL(origin: ValidOrigin): string {
  ...
  switch (origin) {
    case VALID_ORIGINS[0]:
      result = PUBLIC_BASE_URL_LOCAL_HEALTH;
      break;
